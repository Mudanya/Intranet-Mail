...
PreparedStatement ps;
    ...
    try{
      ...
      res=dbcon.getResult("select password from register where username='"+nem+"' and password='"+oldp+"'", con);
     
      if(res.next())
      {
          stm=con.createStatement();
          String updet="update register set password='"+newp+"' where username='"+nem+"'";
